...
@section('content')
    <div class="container-fluid px-3 px-md-4">
        ...
        <div class="info-card-modern mb-4">
            <div class="d-flex align-items-start">
                ...
                <div class="info-content">
                    ...
                    <p class="info-text mb-0">Puede actualizar los datos sanitarios de cualquier animal registrado en el
                        sistema.
        ...
        <form action="{{ route('admin.datos-sanitarios.update', $datoSanitario->id) }}" method="POST"
            enctype="multipart/form-data" id="formDatosSanitarios">
            @csrf
            @method('PUT')
                                ...
                                <div class="checkbox-modern-wrapper">
                                    <div class="checkbox-modern">
                                        <input type="checkbox" class="checkbox-input" name="vacunado_fiebre_aftosa"
                                            ...
                                            {{ old('vacunado_fiebre_aftosa', $datoSanitario->vacunado_fiebre_aftosa) ? 'checked' : '' }}>
                                    ...
                                    <div class="checkbox-modern">
                                        <input type="checkbox" class="checkbox-input" name="vacunado_antirabica"
                                            ...
                                            {{ old('vacunado_antirabica', $datoSanitario->vacunado_antirabica) ? 'checked' : '' }}>
                                ...
                                <div class="switch-grid">
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_campeon_raza"
                                            ...
                                            {{ old('logro_campeon_raza', $datoSanitario->logro_campeon_raza) ? 'checked' : '' }}>
                                    ...
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_gran_campeon_macho"
                                            ...
                                            {{ old('logro_gran_campeon_macho', $datoSanitario->logro_gran_campeon_macho) ? 'checked' : '' }}>
                                    ...
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_gran_campeon_hembra"
                                            ...
                                            {{ old('logro_gran_campeon_hembra', $datoSanitario->logro_gran_campeon_hembra) ? 'checked' : '' }}>
                                    ...
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_mejor_ubre"
                                            ...
                                            {{ old('logro_mejor_ubre', $datoSanitario->logro_mejor_ubre) ? 'checked' : '' }}>
                                ...
                                <div class="switch-grid">
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_campeona_litros_dia"
                                            ...
                                            {{ old('logro_campeona_litros_dia', $datoSanitario->logro_campeona_litros_dia) ? 'checked' : '' }}>
                                    ...
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_mejor_lactancia"
                                            ...
                                            {{ old('logro_mejor_lactancia', $datoSanitario->logro_mejor_lactancia) ? 'checked' : '' }}>
                                    ...
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_mejor_calidad_leche"
                                            ...
                                            {{ old('logro_mejor_calidad_leche', $datoSanitario->logro_mejor_calidad_leche) ? 'checked' : '' }}>
                                ...
                                <div class="switch-grid">
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_mejor_novillo"
                                            ...
                                            {{ old('logro_mejor_novillo', $datoSanitario->logro_mejor_novillo) ? 'checked' : '' }}>
                                    ...
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_gran_campeon_carne"
                                            ...
                                            {{ old('logro_gran_campeon_carne', $datoSanitario->logro_gran_campeon_carne) ? 'checked' : '' }}>
                                    ...
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_mejor_semental"
                                            ...
                                            {{ old('logro_mejor_semental', $datoSanitario->logro_mejor_semental) ? 'checked' : '' }}>
                                ...
                                <div class="switch-grid">
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_mejor_madre"
                                            ...
                                            {{ old('logro_mejor_madre', $datoSanitario->logro_mejor_madre) ? 'checked' : '' }}>
                                    ...
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_mejor_padre"
                                            ...
                                            {{ old('logro_mejor_padre', $datoSanitario->logro_mejor_padre) ? 'checked' : '' }}>
                                    ...
                                    <div class="switch-modern">
                                        <input type="checkbox" class="switch-input" name="logro_mejor_fertilidad"
                                            ...
                                            {{ old('logro_mejor_fertilidad', $datoSanitario->logro_mejor_fertilidad) ? 'checked' : '' }}>
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-muted mb-0 small">
                                                    <a href="{{ asset('storage/' . $datoSanitario->arbol_genealogico) }}"
