                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        <div class="card-body p-0">
                            <div class="position-relative"
                                style="overflow: hidden; border-radius: 8px 8px 0 0; background:#fff;">
                                {{-- CONTENEDOR FIJO + IMAGEN SIN RECORTE --}}
                                <div class="d-flex justify-content-center align-items-center" style="height: 400px;">
                                    <img id="mainImage" src="{{ asset('storage/' . $maquinaria->imagenes->first()->ruta) }}"
                                ...
                                <div class="border-top pt-4">
                                    <form action="{{ route('cart.add') }}" method="POST">
                                        ...
                                        <div class="form-row align-items-end">
                                            <div class="col-auto">
                                                <label class="small font-weight-bold text-muted mb-2 d-block">Días de
                                                    alquiler</label>
                                                <input type="number" name="dias_alquiler" class="form-control form-control-lg"
                                                    value="1" min="1" required style="width: 150px;">
                                            </div>
                                            <div class="col">
