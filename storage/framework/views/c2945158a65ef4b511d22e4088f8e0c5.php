                                                ...
                                                <div class="d-flex flex-wrap align-items-end gap-3" style="gap: 1rem;">
                                                    <div style="min-width: 140px;">
                                                        ...
                                                        <form action="<?php echo e(route('cart.update', $item)); ?>" method="POST"
                                                            id="quantityForm<?php echo e($item->id); ?>" style="margin: 0;">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('PUT'); ?>
                                                            <div class="quantity-controls">
                                                                <button type="button" class="quantity-btn"
                                                                    onclick="decreaseQuantity(<?php echo e($item->id); ?>)">
                                                                    <i class="fas fa-minus"></i>
                                                                </button>
                                                                <input type="number" name="cantidad" class="quantity-input"
                                                                    value="<?php echo e($item->cantidad); ?>" min="1"
                                                                    id="quantity<?php echo e($item->id); ?>"
                                                                    onchange="updateQuantity(<?php echo e($item->id); ?>)"
                                                                    readonly>
                                                                <button type="button" class="quantity-btn"
                                                                    onclick="increaseQuantity(<?php echo e($item->id); ?>)">
                                                    ...
                                                    <div style="min-width: 100px;">
                                                        ...
                                                        <div class="subtotal-display"
                                                            ...
                                                            <?php echo e(number_format($item->precio_unitario, 2)); ?></div>
                                                    </div>
                                                    ...
                                                    <div style="min-width: 100px; text-align: right;">
                                                        ...
                                                        <div class="price-display"
                                                            ...
                                                            <?php echo e(number_format($item->subtotal, 2)); ?></div>
                                                    </div>

                                                    <div class="ml-auto">
                                                        <form action="<?php echo e(route('cart.remove', $item)); ?>" method="POST"
                                                            class="d-inline" id="removeForm<?php echo e($item->id); ?>">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('DELETE'); ?>
                                                            <button type="button" class="btn btn-danger btn-sm"
                                                                onclick="confirmRemoveItem(<?php echo e($item->id); ?>)"
                            ...
                            <div class="col-lg-4">
                                <div class="cart-summary">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <form id="checkoutForm" action="<?php echo e(route('pedidos.store')); ?>" method="POST"
                                            style="display: none;">
                                            <?php echo csrf_field(); ?>
                                        </form>
