  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(url('/')); ?>" class="nav-link">Inicio</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
    ...
    <div class="sidebar">
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column">
          ...
          <!-- TIPOS DE ANIMAL -->
          <li class="nav-item">
            <a href="<?php echo e(route('tipo_animals.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('tipo_animals.*') ? 'active' : ''); ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('categorias.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('categorias.*') ? 'active' : ''); ?>">
          ...
          <!-- TIPO DE PESO -->
          <li class="nav-item">
            <a href="<?php echo e(route('tipo-pesos.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('tipo-pesos.*') ? 'active' : ''); ?>">
...
<li class="nav-item">
    <a href="<?php echo e(route('datos-sanitarios.index')); ?>"
       class="nav-link <?php echo e(request()->routeIs('datos-sanitarios.*') ? 'active' : ''); ?>">
