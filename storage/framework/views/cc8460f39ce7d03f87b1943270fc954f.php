                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="animal-card">
                                    ...
                                    <div class="animal-image-wrapper"
                                        <?php if($imagenPrincipal): ?> onclick="window.open('<?php echo e(asset('storage/' . $imagenPrincipal)); ?>', '_blank')"
                       title="Click para ver imagen completa" <?php endif; ?>>
                                        <?php if($imagenPrincipal): ?>
                                            <img src="<?php echo e(asset('storage/' . $imagenPrincipal)); ?>" alt="<?php echo e($ganado->nombre); ?>"
                                                class="animal-image">
                                        <?php else: ?>
                                        ...
                                        <?php if($ganado->fecha_publicacion): ?>
                                            <div class="info-row">
                                                ...
                                                <span class="text-success">
                                                    ...
                                                    <?php echo e(\Carbon\Carbon::parse($ganado->fecha_publicacion)->format('d/m/Y')); ?>
                                        ...
                                        <?php if($ganado->datoSanitario): ?>
                                            <div class="info-row">
                                                ...
                                                <span class="text-info">
                                                    ...
                                                    <?php echo e(Str::limit($ganado->datoSanitario->vacuna ?? 'Registrado', 40)); ?>
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <span
                                                class="stock-badge badge <?php echo e(($ganado->stock ?? 0) > 0 ? 'badge-success' : 'badge-danger'); ?>">
                                            ...
                                            <?php if(auth()->check() && (auth()->user()->isVendedor() || auth()->user()->isAdmin())): ?>
                                                <?php if(auth()->user()->isAdmin() || $ganado->user_id == auth()->id()): ?>
                                                    ...
                                                    <form action="<?php echo e(route('ganados.destroy', $ganado->id)); ?>"
                                                        method="POST" class="d-inline" id="deleteForm<?php echo e($ganado->id); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <button type="button" class="btn btn-danger btn-action"
                                                            onclick="confirmDelete(<?php echo e($ganado->id); ?>)" title="Eliminar">
