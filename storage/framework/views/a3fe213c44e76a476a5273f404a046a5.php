...
<div class="container-fluid">
    <div class="organic-units-card card">
        ...
        <div class="organic-units-header">
            ...
            <a href="<?php echo e(route('admin.unidades_organicos.create')); ?>" class="btn btn-light btn-sm">
        ...
        <div class="organic-units-body">
            ...
            <div class="row align-items-center mb-3">
                <div class="col-md-6 organic-units-search mb-2 mb-md-0">
                    <form method="GET" action="<?php echo e(route('admin.unidades_organicos.index')); ?>">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="<?php echo e(route('admin.unidades_organicos.edit', $item)); ?>"
                                       class="btn btn-primary btn-action"
                                       title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="<?php echo e(route('admin.unidades_organicos.destroy', $item)); ?>"
                                          method="post"
                                          class="d-inline"
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Nicole\proyecto\Proyecto-Agricola\resources\views/unidades_organicos/index.blade.php ENDPATH**/ ?>