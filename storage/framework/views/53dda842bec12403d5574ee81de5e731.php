...
<div class="container-fluid">
    <div class="categories-card card">
        ...
        <div class="categories-header">
            ...
            <a href="<?php echo e(route('admin.categorias.create')); ?>" class="btn btn-light btn-sm">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="<?php echo e(route('admin.categorias.edit', $categoria)); ?>" class="btn btn-primary btn-action">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="<?php echo e(route('admin.categorias.destroy', $categoria)); ?>"
                                          method="POST"
                                          class="d-inline"
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Nicole\proyecto\Proyecto-Agricola\resources\views/categorias/index.blade.php ENDPATH**/ ?>