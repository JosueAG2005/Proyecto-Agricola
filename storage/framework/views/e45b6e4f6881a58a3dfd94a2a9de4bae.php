...
<?php $__env->startSection('content'); ?>
    <style>
        ...
        /* NUEVO: evitar zoom/recorte en maquinaria y orgánicos */
        .card-maquinaria-img,
        .card-organico-img {
    ...
    <section class="container py-4">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('ads.index')); ?>" class="row align-items-end" id="filtroForm">
        ...
        <?php if($totalResultados > 0 || (!request()->has('q') && !request()->has('categoria_id') && !request()->has('tipo'))): ?>
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <a href="<?php echo e(route('ganados.show', $ganado->id)); ?>" class="text-decoration-none"
                                    ...
                                    <div class="card h-100 ganado-card shadow-lg rounded-lg border-success border-3 overflow-hidden"
                                        ...
                                        <?php else: ?>
                                            <div class="ad-img bg-light d-flex align-items-center justify-content-center"
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <ul class="ad-meta list-unstyled mb-2">
                                                <?php if($ganado->ubicacion): ?>
                                                    <li class="mb-1"><i class="fas fa-map-marker-alt text-success"></i>
                                                        <span
                                                            class="small"><?php echo e(Str::limit($ganado->ubicacion, 40)); ?></span>
                                                    </li>
                                                <?php endif; ?>
                                                <?php if($ganado->tipoAnimal): ?>
                                                    <li class="mb-1"><i class="fas fa-paw text-success"></i> <span
                                                            class="small"><?php echo e($ganado->tipoAnimal->nombre); ?></span></li>
                                                <?php endif; ?>
                                                <?php if($ganado->edad): ?>
                                                    <li class="mb-1"><i class="fas fa-birthday-cake text-success"></i>
                                                        <span class="small"><?php echo e($ganado->edad); ?> meses</span></li>
                                                <?php endif; ?>
                                            ...
                                            <div class="mb-2">
                                                <span class="badge badge-success badge-lg px-3 py-2 shadow-sm">
                                                    ...
                                                    <?php echo e($ganado->categoria->nombre ?? 'Animales'); ?>
                                        ...
                                        <div
                                            ...
                                            <?php if($ganado->precio): ?>
                                                <span class="price font-weight-bold text-success">Bs
                                                    <?php echo e(number_format($ganado->precio, 2)); ?></span>
                                            <?php else: ?>
                                ...
                                <a href="<?php echo e(route('maquinarias.show', $maquinaria->id)); ?>" class="text-decoration-none"
                                    ...
                                    <div class="card h-100 ganado-card shadow-lg rounded-lg border-success border-3 overflow-hidden"
                                        ...
                                        <?php if($imagenPrincipal): ?>
                                            <div class="card-img-wrapper position-relative overflow-hidden">
                                                <img src="<?php echo e(asset('storage/' . $imagenPrincipal)); ?>"
                                                    class="ad-img card-maquinaria-img"
                                                    style="height:220px; object-fit:cover; transition: transform 0.3s ease;"
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <ul class="ad-meta list-unstyled mb-2">
                                                ...
                                                <?php if($maquinaria->created_at): ?>
                                                    <li class="mb-1"><i class="fas fa-calendar-alt text-success"></i>
                                                        <span class="small">Publicado:
                                                            <?php echo e(\Carbon\Carbon::parse($maquinaria->created_at)->format('d/m/Y')); ?></span>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>
                                            <div class="mb-2">
                                ...
                                <a href="<?php echo e(route('organicos.show', $organico->id)); ?>" class="text-decoration-none"
                                    ...
                                    <div class="card h-100 ganado-card shadow-lg rounded-lg border-success border-3 overflow-hidden"
                                        ...
                                        <?php if($imagenPrincipal): ?>
                                            <div class="card-img-wrapper position-relative overflow-hidden">
                                                <img src="<?php echo e(asset('storage/' . $imagenPrincipal)); ?>"
                                                    class="ad-img card-organico-img"
                                                    style="height:220px; object-fit:cover; transition: transform 0.3s ease;"
            ...
            <?php if($totalResultados == 0 && (request()->has('q') || request()->has('categoria_id') || request()->has('tipo'))): ?>
                <div class="alert alert-info text-center py-5">
                    ...
                    <p>Intenta con otros términos de búsqueda o <a href="<?php echo e(route('ads.index')); ?>">ver todos los
                            anuncios</a></p>
                </div>
            <?php endif; ?>
        <?php else: ?>
