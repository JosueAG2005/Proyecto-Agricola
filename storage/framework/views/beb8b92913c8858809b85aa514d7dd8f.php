                ...
                <div class="card h-100 shadow-sm project-card">
                    ...
                    <div class="bg-light d-flex align-items-center justify-content-center" style="height: 230px;">
                        <?php if($m->imagenes && $m->imagenes->count() > 0): ?>
                            <div class="bg-light d-flex align-items-center justify-content-center" style="height: 230px;">
                                <img src="<?php echo e($m->imagenes->count() ? asset('storage/' . $m->imagenes->first()->ruta) : asset('img/maquinaria-placeholder.jpg')); ?>"
                    ...
                    <div class="card-footer bg-white">
                        <div class="d-grid gap-2">
                            <a href="<?php echo e(route('maquinarias.show', $m)); ?>" class="btn btn-outline-success btn-block mb-1">
                            ...
                            <?php if(auth()->check() && (auth()->user()->isVendedor() || auth()->user()->isAdmin())): ?>
                                <?php if(auth()->user()->isAdmin() || $m->user_id == auth()->id()): ?>
                                    ...
                                    <form action="<?php echo e(route('maquinarias.destroy', $m)); ?>" method="post"
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Nicole\proyecto\Proyecto-Agricola\resources\views/maquinarias/index.blade.php ENDPATH**/ ?>