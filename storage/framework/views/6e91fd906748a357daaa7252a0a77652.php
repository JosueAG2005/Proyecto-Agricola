...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('admin.datos-sanitarios.update', $datoSanitario->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="custom-control custom-checkbox custom-control-lg mb-3">
                                <input type="checkbox" class="custom-control-input" name="vacunado_fiebre_aftosa" id="vacunado_fiebre_aftosa" value="1"
                                       <?php echo e($datoSanitario->vacunado_fiebre_aftosa ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="custom-control custom-checkbox custom-control-lg mb-3">
                                <input type="checkbox" class="custom-control-input" name="vacunado_antirabica" id="vacunado_antirabica" value="1"
                                       <?php echo e($datoSanitario->vacunado_antirabica ? 'checked' : ''); ?>>
        ...
        <div class="card shadow-sm mb-4 border-left-warning">
            ...
            <div class="card-body">
                <?php if($datoSanitario->certificado_imagen): ?>
                    <div class="mb-3 p-3 bg-light rounded">
                        ...
                        <img src="<?php echo e(asset('storage/'.$datoSanitario->certificado_imagen)); ?>" 
                             alt="Certificado SENASAG" 
                             class="img-thumbnail" 
                             style="max-width: 300px; max-height: 300px; cursor: pointer;"
                             onclick="window.open('<?php echo e(asset('storage/'.$datoSanitario->certificado_imagen)); ?>', '_blank')"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php if($datoSanitario->carnet_dueño_foto): ?>
                                <div class="mb-2 p-2 bg-light rounded">
                                    <img src="<?php echo e(asset('storage/'.$datoSanitario->carnet_dueño_foto)); ?>" 
                                         alt="Carnet Dueño" 
                                         class="img-thumbnail" 
                                         style="max-width: 200px; max-height: 200px; cursor: pointer;"
                                         onclick="window.open('<?php echo e(asset('storage/'.$datoSanitario->carnet_dueño_foto)); ?>', '_blank')"
                                         title="Click para ver imagen completa">
                                </div>
                            <?php endif; ?>
                            <div class="custom-file">
