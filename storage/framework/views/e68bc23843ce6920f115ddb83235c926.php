                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                    ...
                    <div class="card shadow-sm border-0 h-100">
                        ...
                        <div class="w-100 d-flex justify-content-center align-items-center"
                            ...
                            <img src="<?php echo e($img ? asset('storage/' . $img) : asset('img/organico-placeholder.jpg')); ?>"
                                style="max-height: 100%; max-width: 100%; object-fit: contain;" alt="<?php echo e($o->nombre); ?>">
                        </div>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mb-2">
                                <?php if($o->categoria): ?>
                                    <span class="badge badge-agro">
                                        <i class="fas fa-tag"></i> <?php echo e($o->categoria->nombre); ?>

                                    </span>
                                <?php endif; ?>

                                <?php if($o->tipoCultivo): ?>
                                    <span class="badge badge-warning">
                                        <i class="fas fa-seedling"></i> <?php echo e($o->tipoCultivo->nombre); ?>
                                ...
                                <?php if($o->unidad): ?>
                                    <span class="badge badge-secondary">
                                        <i class="fas fa-balance-scale"></i> <?php echo e($o->unidad->nombre); ?>
                            ...
                            <p class="mb-2">
                                <small class="text-muted">
                                    ...
                                    <?php elseif($o->latitud_origen && $o->longitud_origen): ?>
                                        Lat: <?php echo e($o->latitud_origen); ?>, Lng: <?php echo e($o->longitud_origen); ?>
                            ...
                            <span class="badge badge-agro mb-3">
                                ...
                                <?php echo e($o->unidad ? strtolower($o->unidad->nombre) : 'unidades'); ?>
                            ...
                            <div class="mt-auto">
                                ...
                                <?php if(auth()->check() && (auth()->user()->isAdmin() || $o->user_id == auth()->id())): ?>
                                    <a href="<?php echo e(route('organicos.edit', $o)); ?>"
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Nicole\proyecto\Proyecto-Agricola\resources\views/organicos/index.blade.php ENDPATH**/ ?>