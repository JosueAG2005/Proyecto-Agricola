...
<div class="card">
    <div class="card-header d-flex align-items-center">
        ...
        <a href="<?php echo e(route('admin.tipo_maquinarias.create')); ?>" class="btn btn-sm btn-success ml-2">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="text-right pr-3">
                        <a href="<?php echo e(route('admin.tipo_maquinarias.edit', $item)); ?>" class="btn btn-sm btn-primary">
                            <i class="fas fa-edit"></i> Editar
                        </a>
                        <form action="<?php echo e(route('admin.tipo_maquinarias.destroy', $item)); ?>" method="post" class="d-inline">
...
<?php echo $__env->make('layouts.adminlte', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\Proyecto-Mercado-Agricola-main\Proyecto-Mercado-Agricola-main\resources\views/tipo_maquinarias/index.blade.php ENDPATH**/ ?>